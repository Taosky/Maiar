...
const RankBox = ({ title, color, type_, navigation, ...rest }) => {
  ...
  return (
    <TouchableOpacity onPress={() => { navigation.navigate('NoTabScreen', { screen: 'RankDetail', params: { type_: type_, title: title } }) }}>
...
export default ({ route, navigation }) => {
  ...
  const rankList = [
    ...
    { title: '华语口碑剧集', color: '#8a8a88', type_: 'tv_chinese_weekly_best' },
    { title: '全球口碑剧集', color: '#885929', type_: 'tv_global_weekly_best' },
